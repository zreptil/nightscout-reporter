 ...
 */
    ...
    if (showColAverage) {
      addTableRow(true, cm(w), row, {
        ...
        'text': '${g.glucFromData(day.avgGluc, 1)}',
        'style': style,
        'alignment': 'right',
        'fontSize': f
      });
    ...
    if (showColMin) {
      addTableRow(true, cm(w), row, {
        ...
        'text': '${g.glucFromData(day.minText, 1)}',
        'style': style,
        'alignment': 'right',
        'fontSize': f
      });
...
//*
    if (showCol1090) {
      addTableRow(true, cm(w), row, {
        ...
        'text': '${g.glucFromData(perc.percentile(10), 1)}',
        'style': style,
        'alignment': 'right',
        'fontSize': f
      });
    ...
    addTableRow(true, cm(w), row, {
      ...
      'text': '${g.glucFromData(perc.percentile(25), 1)}',
      'style': style,
      'alignment': 'right',
      'fontSize': f
    });
    addTableRow(true, cm(w), row, {
      ...
      'text': '${g.glucFromData(perc.percentile(50), 1)}',
      'style': style,
      'alignment': 'right',
      'fontSize': f
    });
    addTableRow(true, cm(w), row, {
      ...
      'text': '${g.glucFromData(perc.percentile(75), 1)}',
      'style': style,
      'alignment': 'right',
      'fontSize': f
    });
    if (showCol1090) {
      addTableRow(true, cm(w), row, {
        ...
        'text': '${g.glucFromData(perc.percentile(90), 1)}',
        'style': style,
        'alignment': 'right',
        'fontSize': f
      });
