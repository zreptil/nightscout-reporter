...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(startTag0, endTag0) => "Después de muchas preguntas sobre la opción de poder donar, ahora he decidido de ofrecer esta posibilidad. Nightscout Reporter sigue siendo completamente gratuito y siempre lo será en el futuro. Si alguien quiere mostrar agradecimiento no me opondré más. El botón de donación no será visible, pero quien quiera donar algo encontrará el ${startTag0}sombrero${endTag0} :)";

  static m1(startTag0, endTag0, startTag1, endTag1, startTag2, endTag2) => "Se ha agregado una nueva vista denominada ${startTag0}Night-Watch${endTag0}. En esta visualización, así como en la pantalla del reloj en la página Nightscout, puede ver el valor actual de glucosa y otra información que puede configurar en cierta medida como desee. Night-Watch se llama a través de esta URL: ${startTag1}https://nightscout-reporter.zreptil.de/watch${endTag1} También se puede llamar desde el menú principal bajo el elemento de menú ${startTag2}Night-Watch${endTag2} o haciendo clic en el valor de azúcar actual en la barra de título de Nightscout Reporter si lo ha activado en la configuración.";

  static m2(startTag0, endTag0) => "Donde se puede crear un CGP, ahora existe la opción ${startTag0}Lineas por rangos${endTag0}. Esto está activado de forma predeterminada. Si está desactivado, los rangos de valores para la persona sana y la persona actual ya no están bordeados por una línea. Esto hace que el gráfico se vea un poco más pálido, pero puede examinar los valores en los ejes más de cerca si lo desea.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Die Einstellung für die Anpassung von BG_TARGET_BOTTOM und BG_TARGET_TOP ist nun unabhängig von der Auswahl \"Glucosewerte anpassen\". Damit kann man die Option umschalten, ohne den Zielbereich auf dem Server neu konfigurieren zu müssen." : MessageLookupByLibrary.simpleMessage("La configuración para ajustar BG_TARGET_BOTTOM y BG_TARGET_TOP ahora es independiente de la selección \"Ajustar valores de glucosa\". Esto permite cambiar la opción sin tener que volver a configurar los objetivos en el servidor."),
