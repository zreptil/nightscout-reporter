...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Die angegebene URL ist nicht erreichbar. Wenn die URL stimmt, dann kann es an den Nightscout-Einstellungen liegen. In der Variable ENABLE muss das Wort \"cors\" stehen, damit externe Tools, wie dieses hier, auf die Daten zugreifen dürfen.<br><br>Wenn diese URL geschützt ist, muss ausserdem das UserToken korrekt definiert sein." : MessageLookupByLibrary.simpleMessage("指定されたURLに接続できません。URLが正しい場合はナイトスカウトの設定が原因の可能性があります。当該ツールのように外部からサイトに接続する場合は、変数ENABLEに”cors\"を追加する必要があります。<br><br>又、URLに保護設定している場合はAPI SecretとUserTokenを正しく設定する必要があります。"),
