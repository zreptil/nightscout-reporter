...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "1.3.0 - xx.07.2019" : MessageLookupByLibrary.simpleMessage("1.3.0 - 2019/07/xx"),
    ...
    "Anzahl Ampullen" : MessageLookupByLibrary.simpleMessage("リザーバー数"),
    "Anzahl Katheter" : MessageLookupByLibrary.simpleMessage("カニューレ数"),
    "Anzahl Messungen" : MessageLookupByLibrary.simpleMessage("値数"),
    "Anzahl Sensoren" : MessageLookupByLibrary.simpleMessage("センサー数"),
    ...
    "Die angegebene URL ist nicht erreichbar. Wenn die URL stimmt, dann kann es an den Nightscout-Einstellungen liegen. In der Variable ENABLE muss das Wort \"cors\" stehen, damit externe Tools, wie dieses hier, auf die Daten zugreifen dürfen.<br><br>Wenn diese URL geschützt ist, muss ausserdem das UserToken korrekt definiert sein." : MessageLookupByLibrary.simpleMessage("指定されたURLに接続できません。URLが正しい場合はナイトスカウトの設定が原因の可能性があります。当該ツールのように外部からサイトに接続する場合は、変数ENABLEに”cros\"を追加する必要があります。<br><br>又、URLに保護設定している場合はAPI SecretとUserTokenを正しく設定する必要があります。"),
    ...
    "Quelle" : MessageLookupByLibrary.simpleMessage("出典"),
    ...
    "ToR [min/d]" : MessageLookupByLibrary.simpleMessage("目標範囲外の時間（分/日）"),
    ...
    "VarK [%]" : MessageLookupByLibrary.simpleMessage("血糖変動係数[%]"),
