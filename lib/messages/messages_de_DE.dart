...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Die angegebene URL ist nicht korrekt." : MessageLookupByLibrary.simpleMessage("Die angegebene URL ist nicht korrekt."),
    "Die angegebene URL konnte nicht erreicht werden." : MessageLookupByLibrary.simpleMessage("Die angegebene URL konnte nicht erreicht werden."),
    ...
    "Url zur Nightscout-API (z.B. https://xxx.herokuapp.com/api/v1" : MessageLookupByLibrary.simpleMessage("Url zur Nightscout-API (z.B. https://xxx.herokuapp.com/api/v1"),
