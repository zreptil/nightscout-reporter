...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(count) => "${Intl.plural(count, zero: '', one: '1 stránka', other: '${count} stránok')}";

  static m5(count) => "${Intl.plural(count, zero: '', one: '1 alebo viac stránok', other: '${count} alebo viac stránok')}";

  static m6(isVisible) => "Prístupový kľúč je potrebný len v prípade, že bol prístup k Nightscout údajom obmedzený nastavením premennej AUTH_DEFAULT_ROLES";

  static m7(time) => "Zobrazená bazálna dávka je platná od ${time} a nezahŕňa žiadne dočasné zmeny.";

  static m8(unit) => "Diese Basalrate war am ${unit} aktiv.";

  static m9(value) => "Bazálna dávka za deň (${value})";

  static m10(value) => "Bazálna dávka z profilu (${value})";

  static m11(value) => "Bolusový inzulín ( ${value} )";

  static m12(value) => "VarK [${value}%]";

  static m13(date) => "Kontrolujem ${date} ...";

  static m14(scale, intercept, slope) => "Kalibrácia (scale ${scale} / intercept ${intercept} / slope ${slope})";

  static m15(value) => "Bolus jedla ( ${value} )";

  static m16(value) => "Sacharidy ( ${value} g)";

  static m17(count, txt) => "${Intl.plural(count, zero: '', one: '( ${txt} deň na katéter)', other: '( ${txt} dní na katéter)')}";

  static m18(name, from, to) => "${name} ${from} => ${to}";

  static m19(url) => "Skontrolujte prístup na ${url} ...";
  ...
  static m21(value) => "Korekčný bolus ( ${value} )";

  static m22(value) => "${Intl.plural(value, zero: 'Žiadna hodnota', one: '1 hodnota', other: '${value} hodnoty')}";

  static m23(value) => "${value} dní";

  static m24(hours, minutes) => "${hours} hod ${minutes} min";

  static m25(isVisible) => "Dátum posledného dňa, z ktorého existujú úplné dáta";

  static m26(beg, end) => "${beg} - ${end}";

  static m27(count) => "${Intl.plural(count, zero: '', one: '1 Formular', other: '${count} Formulare')}";

  static m28(max) => "zlé (viac ako ${max} )";

  static m29(min, max) => "dobré ( ${min} až ${max} )";

  static m30(min) => "nie je k dispozícii (malý ${min} )";

  static m31(min, max) => "veľmi dobré ( ${min} až ${max} )";

  static m32(time) => "${Intl.plural(time, zero: 'Gerade eben', one: 'vor ${time} Minute', other: 'vor ${time} Minuten')}";

  static m33(unit, value) => "Intenzita HYPER\n[${unit} x min²]";

  static m34(unit) => "Intenzita hyperglykémie za deň (hodnoty väčšie alebo rovné ${unit}).";

  static m35(unit, value) => "Intenzita HYPO\n[${unit} x min²]";

  static m36(unit) => "Intenzita hypoglykémie za deň (hodnoty menšie alebo rovné ${unit}).";

  static m37(value) => "Vysoko ${value}";

  static m38(value) => "Historicky ${value}";

  static m39(value) => "Hypoglykémie (< ${value})";

  static m40(unit) => "Faktory citlivosti na inzulín (ISF) 1 IU znižujú BG o X ${unit}";

  static m41(value) => "${value}g";

  static m42(value) => "g sach. ( ${value} BE)";

  static m43(date) => "KW${date}";

  static m44(value) => "Celkový inzulín ( ${value} )";

  static m45(error, stacktrace) => "Chyba pri načítaní údajov: \n${error}\n${stacktrace}";

  static m46(date) => "Načítavajú sa údaje z ${date}...";
  ...
  static m50(percent, duration) => "temp. Bazál ${percent}% / ${duration} min";

  static m51(value, duration) => "temp. Basal ${value} / ${duration} min";

  static m52(target, duration, reason) => "temp. ${target} cieľ na ${duration} min, dôvod: ${reason}";

  static m53(value) => "Nízko${value}";

  static m54(gluc, unit) => "Meranie z krvi ${gluc} ${unit}";

  static m55(unit, value) => "Stredná glykémia\n[${unit}]";

  static m56(hba1c) => "Glykemický priemer v uvažovanom období.";
  ...
  static m59(min, max) => "zlé ( ${min} až ${max} )";

  static m60(min, max) => "dobré ( ${min} až ${max} )";

  static m61(max) => "veľmi zlé (viac ako ${max} )";

  static m62(min) => "vynikajúci (menej ako ${min} )";
  ...
  static m66(oldName, newName) => "Zmena profilu z ${oldName} => ${newName}";

  static m67(oldName, newName, duration) => "Zmena profilu z ${oldName} => ${newName} po ${duration} minút";

  static m68(howMany, fmt) => "${Intl.plural(howMany, zero: 'Nie sú k dispozícii žiadne údaje', one: '1 meranie za minútu', other: 'Meranie každých ${fmt} minút')}";

  static m69(howMany, fmt) => "${Intl.plural(howMany, zero: 'Nie sú k dispozícii žiadne údaje', one: '1 meranie denne', other: '${fmt} meraní denne')}";

  static m70(howMany, fmt) => "${Intl.plural(howMany, zero: 'Nie sú k dispozícii žiadne údaje', one: '1 meranie za hodinu', other: '${fmt} meraní za hodinu')}";

  static m71(count, txt) => "${Intl.plural(count, zero: '', one: '( ${txt} deň na ampulku)', other: '( ${txt} dní na ampulku)')}";

  static m72(value) => "SMB ( ${value} )";

  static m73(count, txt) => "${Intl.plural(count, zero: '', one: '( ${txt} deň na snímač)', other: '( ${txt} dní na snímač)')}";

  static m74(low, high, unit) => "Použiť štandardný rozsah hodnôt (${low} ${unit} - ${high} ${unit})";

  static m75(isVisible) => "Dátum prvého dňa s údajmi";

  static m76(value) => "(StdDev ${value})";

  static m77(value) => "ToR [${value}min/d]";

  static m78(min, max) => "Počet minút v dni, počas ktorých sú hodnoty mimo rozsahu ${min} až ${max} .";

  static m79(unit) => "Cieľová oblasť glukózy ${unit}";

  static m80(min, max, units) => "Cieľový rozsah ( ${min} - ${max} ${units} )";

  static m81(value) => "cieľová hodnota";

  static m82(time) => "${time} hod";
  ...
  static m87(begDate) => "platné od ${begDate}";

  static m88(begDate, endDate) => "platné od ${begDate} do ${endDate}";

  static m89(endDate) => "platí do ${endDate}";

  static m90(high) => "Hodnoty nad ${high}";

  static m91(low) => "Hodnoty pod ${low}";

  static m92(low, high) => "Hodnoty medzi ${low} a ${high}";

  static m93(low, high) => "Cieľová oblasť ( ${low} - ${high} )";

  static m94(value) => "Vysoké hodnoty ( ${value} )";

  static m95(value) => "Nízke hodnoty ( ${value} )";

  static m96(value) => "Veľmi vysoké hodnoty (> ${value} )";

  static m97(value) => "Veľmi nízke hodnoty (< ${value} )";
