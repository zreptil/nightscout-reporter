...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(value) => "g CHO ( ${value} BU)";

  static m4(error, stacktrace) => "Error loading data: ${error} ${stacktrace}";

  static m5(date) => "Loading data for ${date} ...";

  static m6(value) => "Low${value}";

  static m7(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per minute', other: '1 value every ${fmt} minutes')}";

  static m8(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per day', other: '${fmt} values a day')}";

  static m9(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per hour', other: '${fmt} values per hour')}";

  static m10(count) => "${Intl.plural(count, zero: '', one: '(Ø ${count} day per reservoir)', other: '(Ø ${count} days per reservoir)')}";

  static m11(begDate) => "valid from ${begDate}";

  static m12(begDate, endDate) => "valid from ${begDate} to ${endDate}";

  static m13(endDate) => "valid until ${endDate}";

  static m14(high) => "Values ​​above ${high} :";

  static m15(low) => "Values ​​below ${low} :";

  static m16(low, high) => "values ​​between ${low} and ${high} :";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Man kann jetzt mehrere Benutzer anlegen. Das ist nützlich, um mehrere Nightscout-Instanzen auszuwerten (z.B. für Ärzte, Betreuer oder den Entwickler dieser Software)" : MessageLookupByLibrary.simpleMessage("You can now create multiple users. This is useful for analyzing multiple nightscout instances (eg, for doctors, caregivers or the developer of this software)"),
