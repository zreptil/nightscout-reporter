...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m5(value) => "Meal Bolus (${value})";

  static m6(value) => "Carbs (${value}g)";

  static m7(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} day per catheter)', other: '(${txt} days per catheter)')}";

  static m8(name, from, to) => "${name} ${from} => ${to}";

  static m9(url) => "Checking access to ${url}...";

  static m10(value) => "Correction Bolus (${value})";

  static m11(value) => "${Intl.plural(value, zero: 'No value', one: '1 value', other: '${value} values')}";

  static m12(value) => "${value} Days";

  static m13(beg, end) => "${beg} - ${end}";

  static m14(max) => "bad (greater than ${max})";

  static m15(min, max) => "good (${min} to ${max})";

  static m16(min) => "not available (less than ${min})";

  static m17(min, max) => "very good (${min} to ${max})";
  ...
  static m27(value) => "Total Daily Dose (${value})";

  static m28(error, stacktrace) => "Error loading data: ${error} ${stacktrace}";

  static m29(date) => "Loading data for ${date}...";
  ...
  static m37(min, max) => "bad (${min} to ${max})";

  static m38(min, max) => "good (${min} to ${max})";

  static m39(max) => "very poor (greater than ${max})";

  static m40(min) => "excellent (less than ${min})";

  static m41(oldName, newName) => "Profileswitch - ${oldName} => ${newName}";

  static m42(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per minute', other: 'value every ${fmt} minute')}";

  static m43(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per day', other: '${fmt} values per day')}";

  static m44(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per hour', other: '${fmt} values per hour')}";

  static m45(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} day per reservoir)', other: '(${txt} days per reservoir)')}";

  static m46(value) => "SMB (${value})";

  static m47(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} day per sensor)', other: '(${txt} days per sensor)')}";

  static m48(value) => "(SDev ${value})";

  static m49(min, max) => "The time per day in minutes in which the values are outside the range ${min} to ${max}.";

  static m50(unit) => "Glucose target area ${unit}";

  static m51(min, max, units) => "Target Range (${min} - ${max} ${units})";

  static m52(value) => "Target Value";
  ...
  static m56(begDate) => "valid since ${begDate}";

  static m57(begDate, endDate) => "valid from ${begDate} to ${endDate}";

  static m58(endDate) => "valid until ${endDate}";

  static m59(high) => "Values ​​above ${high}";

  static m60(low) => "Values ​​below ${low}";

  static m61(low, high) => "Values ​​between ${low} and ${high}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "1.3.0 - xx.07.2019" : MessageLookupByLibrary.simpleMessage("1.3.0 - 07/xx/2019"),
