...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Die Einstellung für die Anpassung von BG_TARGET_BOTTOM und BG_TARGET_TOP ist nun unabhängig von der Auswahl \"Glucosewerte anpassen\". Damit kann man die Option umschalten, ohne den Zielbereich auf dem Server neu konfigurieren zu müssen." : MessageLookupByLibrary.simpleMessage("Le réglage pour ajuster BG_TARGET_BOTTOM et BG_TARGET_TOP est maintenant indépendant de la sélection \"Ajuster les valeurs de glucose\". Cela vous permet d\'activer/désactiver l\'option sans avoir à reconfigurer la zone cible sur le serveur."),
    ...
    "Night-Watch zeigt nun auch Werte an, wenn diese von mehreren Uploadern innerhalb kurzer Zeit mehrfach in Nightscout gespeichert wurden. Das sollte man zwar möglichst vermeiden, aber nun kann Night-Watch auch damit umgehen." : MessageLookupByLibrary.simpleMessage("Night-Watch affiche désormais des valeurs si elles ont été enregistrées plusieurs fois dans Nightscout par plusieurs téléverseurs dans un laps de temps court. Cela devrait être évité si possible, mais maintenant Night-Watch peut également traiter avec lui."),
