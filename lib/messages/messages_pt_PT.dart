...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(time) => "A taxa de basal tem sido válida desde ${time} e não inclui nenhuma alteração temporária.";

  static m4(unit) => "Este basalrate estava ativo em ${unit}.";

  static m5(value) => "Taxa Basal do dia (${value})";

  static m6(value) => "Taxa Basal do perfil (${value})";

  static m7(value) => "Insulina Bolus (${value})";

  static m8(value) => "CV [${value}%]";

  static m9(date) => "Verificando ${date} ...";

  static m10(scale, intercept, slope) => "Calibração (escala ${scale} / interceptação em ${intercept} / coeficiente angular ${slope})";

  static m11(value) => "Bolus da refeição (${value})";

  static m12(value) => "Hidratos de Carbono (${value}g)";

  static m13(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} dia por cateter)', other: '(${txt} dias por cateter)')}";

  static m14(name, from, to) => "${name} ${from} => ${to}";

  static m15(url) => "Comunicando com ${url}...";

  static m16(value) => "Bolus de Correção (${value})";

  static m17(value) => "${Intl.plural(value, zero: 'Sem valor', one: '1 valor', other: '${value} valores')}";
  ...
  static m23(max) => "mau (greater than ${max})";

  static m24(min, max) => "bom (${min} para ${max})";

  static m25(min) => "não disponível (less than ${min})";

  static m26(min, max) => "muito bom (${min} para ${max})";

  static m27(unit, value) => "Intensidade HIPER\n[${unit} x min²]";

  static m28(unit) => "A intensidade da hiperglicemia por dia (valores maiores ou iguais a ${unit}).";

  static m29(unit, value) => "Intensidade HIPO\n[${unit} x min²]";

  static m30(unit) => "A intensidade da hipoglicemia por dia (valores menores ou iguais a ${unit}).";

  static m31(value) => "Alto${value}";

  static m32(value) => "Histórico ${value}";

  static m33(value) => "Hipos (< ${value})";

  static m34(unit) => "Fator de Sensibilidade da Insulina (ISF) 1 U reduz BG em X ${unit}";

  static m35(value) => "${value}g";

  static m36(value) => "g CH (${value} BU)";

  static m37(value) => "Dose Total Diário (${value})";

  static m38(error, stacktrace) => "Erro ao carregar dados: ${error} ${stacktrace}";

  static m39(date) => "A carregando dados para ${date}...";
  ...
  static m43(percent, duration) => "basal temporária ${percent}% / ${duration} min";

  static m44(value, duration) => "temp. Basal ${value} / ${duration} min";

  static m45(target, duration, reason) => "alvo temporário ${target} por ${duration} min, motivo: ${reason}";

  static m46(value) => "Baixo${value}";

  static m47(gluc, unit) => "Valor do sangue ${gluc} ${unit}";

  static m48(unit, value) => "Glicose média\n[${unit}]";

  static m49(hba1c) => "O valor da glicémia médio no período especificado.";

  static m50(min, max) => "mau (${min} para ${max})";

  static m51(min, max) => "bom (${min} para ${max})";

  static m52(max) => "muito mau (maior que ${max})";

  static m53(min) => "excelente (menor que ${min})";

  static m54(oldName, newName) => "TrocaPerfil - ${oldName} => ${newName}";

  static m55(oldName, newName, duration) => "Profileswitch - ${oldName} => ${newName} por ${duration} Minutos";

  static m56(howMany, fmt) => "${Intl.plural(howMany, zero: 'Sem valores disponiveis', one: '1 valor por minuto', other: 'valor a cada ${fmt} minutos')}";

  static m57(howMany, fmt) => "${Intl.plural(howMany, zero: 'Sem dados disponiveis', one: '1 valor por dia', other: '${fmt} valores por dia')}";

  static m58(howMany, fmt) => "${Intl.plural(howMany, zero: 'Sem valores disponiveis', one: '1 valor por hora', other: '${fmt} valores por horas')}";

  static m59(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} dia por reservatório)', other: '(${txt} dias por reservatório)')}";

  static m60(value) => "SMB (${value})";

  static m61(count, txt) => "${Intl.plural(count, zero: '', one: '(${txt} dia por sensor)', other: '(${txt} dias por sensor)')}";

  static m62(low, high, unit) => "Usar intervalo padrão (${low} ${unit} - ${high} ${unit})";

  static m63(isVisible) => "The date of the first day with data";

  static m64(value) => "(DesvP ${value})";

  static m65(value) => "ToR [${value}min/d]";

  static m66(min, max) => "O tempo por dia em minutos em que os valores estão fora do intervalo de ${min} a ${max}.";

  static m67(unit) => "Intervalo alvo da glicose ${unit}";

  static m68(min, max, units) => "Intervalo Alvo(${min} - ${max} ${units})";

  static m69(value) => "Valor de Alvo";
  ...
  static m74(maxCount) => "Nem todos os perfis puderam ser carregados porque mais de ${maxCount} são gravados no período selecionado. ";

  static m75(begDate) => "válido desde ${begDate}";

  static m76(begDate, endDate) => "válido de ${begDate} para ${endDate}";

  static m77(endDate) => "válido até ${endDate}";

  static m78(high) => "Valores acima de ${high}";

  static m79(low) => "Valores abaixo ${low}";

  static m80(low, high) => "Valor entre ${low} e ${high}";

  static m81(low, high) => "Intervalo alvo (${low} - ${high})";

  static m82(value) => "Valores altos (${value})";

  static m83(value) => "Valores baixos (${value})";

  static m84(value) => "Valores muito altos ( > ${value})";

  static m85(value) => "Valores muito baixos (< ${value})";
