...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m17(howMany, fmt) => "${Intl.plural(howMany, zero: 'No values available', one: '1 value per minute', other: '${fmt} values every ${fmt} minute')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Seite für Tagesnotizen" : MessageLookupByLibrary.simpleMessage("Page for day notes"),
    ...
    "ViewWhatsnewComponent0__message_59" : m0,
