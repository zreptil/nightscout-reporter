...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m24(value) => "Low${value}";

  static m25(min, max) => "bad (${min} to ${max})";

  static m26(min, max) => "good (${min} to ${max})";

  static m27(max) => "very poor (greater than ${max})";

  static m28(min) => "excellent (less than ${min})";

  static m29(oldName, newName) => "Profileswitch - ${oldName} => ${newName}";
  ...
  static m34(count, txt) => "${Intl.plural(count, zero: 'brak danych', one: '(${txt} dzień na sensor)', other: '(${txt} dni na sensor)')}";

  static m35(value) => "(SDev ${value})";

  static m36(unit) => "Glucose target area ${unit}";

  static m37(min, max, units) => "Zakres docelowy (${min} - ${max} ${units})";

  static m38(value) => "Wartość docelowa";
  ...
  static m42(begDate) => "obowiązuje od ${begDate}";

  static m43(begDate, endDate) => "obowiązuje od ${begDate} do ${endDate}";

  static m44(endDate) => "obowiązuje do ${endDate}";

  static m45(high) => "Odczyty powyżej ${high}";

  static m46(low) => "Odczyty poniżej ${low}";

  static m47(low, high) => "Odczyty między ${low} i ${high}";
